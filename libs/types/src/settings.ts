...
export interface AIProfile {
  ...
  icon?: string;
  /** Optional system prompt to inject for specialized agents (e.g., Frontend Specialist, Security Specialist) */
  systemPrompt?: string;
}
...
/**
 * ProjectSettings - Project-specific overrides stored in {projectPath}/.automakeit/settings.json
 *
