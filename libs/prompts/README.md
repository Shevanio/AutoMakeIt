...
```bash
npm install @automakeit/prompts
```
...
```typescript
import { getSystemPrompt } from '@automakeit/prompts';
...
```typescript
import { getExamples } from '@automakeit/prompts';
...
```typescript
import { buildUserPrompt } from '@automakeit/prompts';
...
```typescript
import { isValidEnhancementMode } from '@automakeit/prompts';
...
```typescript
import { getAvailableEnhancementModes } from '@automakeit/prompts';
...
```typescript
import { isValidEnhancementMode, getAvailableEnhancementModes } from '@automakeit/prompts';
...
```typescript
import { getSystemPrompt, buildUserPrompt, getExamples } from '@automakeit/prompts';
...
- `@automakeit/types` - Type definitions for EnhancementMode and EnhancementExample

## Used By

- `@automakeit/server` - Enhancement API routes
