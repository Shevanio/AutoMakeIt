  ...
  describe('loadContextFiles', () => {
    ...
    it('should recursively load files from subdirectories', async () => {
      const fileStructure = new Map([
        ['/fake/project/.automaker/context', ['docs', 'CLAUDE.md', 'context-metadata.json']],
        ['/fake/project/.automaker/context/docs', ['api', 'README.md']],
        ['/fake/project/.automaker/context/docs/api', ['auth.md']],
      ]);
