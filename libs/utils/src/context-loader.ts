 ...
 *
 * Provides a shared utility to load context files from .automakeit/context/
 ...
 *
 * Supports:
 * - Recursive directory scanning (folders within .automakeit/context/)
 ...
 * Stored in {projectPath}/.automakeit/context/context-metadata.json
 *
...
function getContextDir(projectPath: string): string {
  return path.join(projectPath, '.automakeit', 'context');
}
...
/**
 * Load context files from a project's .automakeit/context/ directory
 *
