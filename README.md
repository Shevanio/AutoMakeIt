<p align="center">
  <img src="apps/ui/public/readme_logo.png" alt="AutoMakeIt Logo" height="80" />
</p>

> **[!NOTE]**
>
> **AutoMakeIt** is an enhanced fork of [AutoMakeIt](https://github.com/AutoMaker-Org/automaker) with substantial improvements:
>
> - WebSocket batch event handling for real-time UI updates
> - Optimized rate limiting with critical endpoint exemptions
> - Modular provider architecture (Claude SDK, OpenAI Codex)
> - Customizable pipeline steps for CI/CD workflows
> - Enhanced security and input validation
> - Improved developer experience and documentation
>
> Total changes: 99 files modified, +10,322/-3,127 lines
...
- [What Makes AutoMakeIt Different?](#what-makes-automakeit-different)
...
![AutoMakeIt UI](https://i.imgur.com/jdwKydM.png)
...
2. **Move to "In Progress"** - AutoMakeIt automatically assigns an AI agent to implement the feature
...
AutoMakeIt leverages the [Claude Agent SDK](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk) to give AI agents full access to your codebase. Agents can read files, write code, execute commands, run tests, and make git commits—all while working in isolated git worktrees to keep your main branch safe. The SDK provides autonomous AI agents that can use tools, make decisions, and complete complex multi-step tasks without constant human intervention.

### Why This Matters

The future of software development is **agentic coding**—where developers become architects directing AI agents rather than manual coders. AutoMakeIt puts this future in your hands today, letting you experience what it's like to build software 10x faster with AI agents handling the implementation while you focus on architecture and business logic.

---

## Credits

**AutoMakeIt** is based on [Automaker](https://github.com/AutoMaker-Org/automaker) by the Automaker team. This fork includes significant enhancements and improvements while maintaining the core vision of agentic coding.

### Key Improvements in AutoMakeIt

- **Real-time UI Updates**: Fixed WebSocket batch event handling for instant board updates
- **Optimized Rate Limiting**: Smart exemptions for critical read-only endpoints
- **Modular Provider Architecture**: Unified interface for multiple AI providers (Claude SDK, OpenAI Codex)
- **Customizable Pipelines**: Define custom workflow steps (code review, security, testing)
- **Enhanced Security**: Comprehensive input validation, path sanitization, and CORS protection
- **Improved Documentation**: Restructured and expanded technical documentation
- **Better Developer Experience**: Cleaner architecture, shared packages, and standardized patterns

Total changes from upstream: **99 files modified**, **+10,322/-3,127 lines**

Original project: https://github.com/AutoMaker-Org/automaker
...
>
> **We do not recommend running AutoMakeIt directly on your local computer** due to the risk of AI agents having access to your entire file system. Please sandbox this application using Docker or a virtual machine.
>
...
- 🛠️ Get help setting up or extending AutoMakeIt
...
git clone git@github.com:Shevanio/AutoMakeIt.git
cd AutoMakeIt
...
# 5. Start AutoMakeIt (interactive launcher)
npm run dev
# Choose between:
...
Start AutoMakeIt in development mode:
...
Docker provides the most secure way to run AutoMakeIt by isolating it from your host filesystem.
...
Once authenticated, AutoMakeIt will automatically detect and use your CLI credentials. No additional configuration needed!
...
AutoMakeIt provides several specialized views accessible via the sidebar or keyboard shortcuts:
...
AutoMakeIt is built as an npm workspace monorepo with two main applications and seven shared packages:
...
AutoMakeIt uses a file-based storage system (no database required):
...
- [Contributing Guide](./CONTRIBUTING.md) - How to contribute to AutoMakeIt
...
This project is licensed under the **AutoMakeIt License Agreement**. See [LICENSE](LICENSE) for the full text.

**Summary of Terms:**

- **Allowed:**
  - **Build Anything:** You can clone and use AutoMakeIt locally or in your organization to build ANY product (commercial or free).
...
- **Restricted (The "No Monetization of the Tool" Rule):**
  - **No Resale:** You cannot resell AutoMakeIt itself.
  - **No SaaS:** You cannot host AutoMakeIt as a service for others.
  - **No Monetizing Mods:** You cannot distribute modified versions of AutoMakeIt for money.
