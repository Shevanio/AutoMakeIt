...
The AutoMakeIt Agent Chat now supports multiple concurrent sessions, allowing you to organize different conversations by topic, feature, or task. Each session is independently managed and persisted.
...
```
~/Library/Application Support/automakeit/agent-sessions/
```

**Windows:**

```
%APPDATA%/automakeit/agent-sessions/
```

**Linux:**

```
~/.config/automakeit/agent-sessions/
```
...
ls -la ~/Library/Application\ Support/automakeit/

# Fix permissions if needed
chmod -R u+w ~/Library/Application\ Support/automakeit/
```
