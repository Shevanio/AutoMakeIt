...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@automakeit/utils': path.resolve(__dirname, '../../libs/utils/src/index.ts'),
      '@automakeit/platform': path.resolve(__dirname, '../../libs/platform/src/index.ts'),
      '@automakeit/types': path.resolve(__dirname, '../../libs/types/src/index.ts'),
      '@automakeit/model-resolver': path.resolve(
        __dirname,
        '../../libs/model-resolver/src/index.ts'
      ),
      '@automakeit/dependency-resolver': path.resolve(
        __dirname,
        '../../libs/dependency-resolver/src/index.ts'
      ),
      '@automakeit/git-utils': path.resolve(__dirname, '../../libs/git-utils/src/index.ts'),
    },
  },
});
