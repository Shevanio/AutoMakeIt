...
import { DEFAULT_MODELS, CLAUDE_MODEL_MAP, type McpServerConfig } from '@automakeit/types';
import { isPathAllowed, PathNotAllowedError, getAllowedRootDirectory } from '@automakeit/platform';
...
// Re-export MCP types from @automakeit/types for convenience
export type {
  McpServerConfig,
