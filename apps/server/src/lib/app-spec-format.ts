...
export type { SpecOutput } from '@automakeit/types';
export { specOutputSchema } from '@automakeit/types';
 ...
 */
export function specToXml(spec: import('@automakeit/types').SpecOutput): string {
  const indent = '  ';
